...
{
    pub field: &'a F,
    pub fs: FiatShamirSim<'a, F>,
    pub polyring: MultivariatePolyRingImpl<F>,
    pub code: C,
    pub ver_rep: usize
}
    ...
    where R: RingStore + Clone, R::Type: DivisibilityRing + FiniteRing
{
    pub fn new(field: &'a AsField<R>, varcount: usize, k0: usize, c: usize, ver_rep: usize) -> Self
    {
        ...
        let fs = FiatShamirSim::new(field);
          ...
          C: FoldableCode<R = AsField<R>>
{
    ...
    fn eval_fast(&mut self, com: &BaseFoldCommitment<AsField<R>>, z: &[El<AsField<R>>], y: El<AsField<R>>, poly: &[El<AsField<R>>])
...
mod tests {
    ...
    fn test_basefoldpcs() {
        ...
        let k0 = 2;
        let c = 2;
        let mut bf = BaseFoldPCS::new(&field, N, k0, c, VREP);
