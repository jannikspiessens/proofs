    ...
    where PCS: MultilinearPCS<'a>, CoeffRing<PCS::Poly>: RingStore<Type: Field>
{
    ...
    {
        // TODO: try immediately putting this in RefCell and then using that to return reference?
        let M = SpartanLincheck::get_zM(&piop, rA, rB, rC, rX);
